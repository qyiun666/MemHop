...
| L5 Capability | `ImportCapability(path)` (v4 package) · `UpdateCapability` · `DeleteCapability` · `ListCapabilities(q)` · `ActivateCapability` · `RecordCapabilityUsage` |
