...
func TestApplySceneBonuses(t *testing.T) {
	...
	applySceneBonuses(scores, map[uint64]struct{}{1: {}}, 1)
	...
	applySceneBonuses(scores, map[uint64]struct{}{}, 2)
	...
	applySceneBonuses(scores, map[uint64]struct{}{3: {}}, 3)
	...
	applySceneBonuses(scores, map[uint64]struct{}{}, 5)
