...
- Never drop the sentence subject or relationship words (我/我的女朋友/我弟弟). If a pronoun cannot be resolved to a concrete name from context, keep the original subject as-is
...
Input: "我女朋友叫王芳，她是设计师。"
Output: {"facts":["我的女朋友叫王芳","我的女朋友王芳是设计师"]}

Input: "上周三我带小花去打了第二针疫苗，花了200块，医生说她很健康。"
Output: {"facts":["上周三我带小花去打了第二针疫苗","我带小花打疫苗花了200块","医生说小花很健康"]}

Input: "我去年三月从北京搬到了深圳，现在在腾讯做算法工程师，年薪80万。"
Output: {"facts":["我去年三月从北京搬到了深圳","我现在在腾讯工作，职位是算法工程师","我的年薪是80万"]}
`
