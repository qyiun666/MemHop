...
func resolveOrCreateGraph(
	...
	if err := record.WriteGraphSlot(engine, newGraphID, &slot); err != nil {
		return 0, err
	}
...
func writeGraphNode(
	...
	return record.WriteHypergraphNode(engine, nodeHash, &node)
}
...
func writeGraphEdge(
	...
	return record.WriteHypergraphEdge(engine, edgeID, &edge)
}
